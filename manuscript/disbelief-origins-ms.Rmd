---
title: "Dual Inheritance Theory and The Origins Of Religious Disbelief"
output:
...
kable(predtab, booktabs= T, caption = "Predictions From Prominent Theories", align=c("l", "l", rep("r", 4))) %>%
   ...
   footnote(number = c("mindblind = relatively lower in advanced mentalizing", "apatheist = relatively more existentially secure", "inCREDulous = exposed to relatively fewer religious CREDs", "Analytic = scoring relatively higher on cognitive reflection"))
```
...
kable(fulltab, booktabs= T, caption = "Full Model Summary", align=c("l", "r", "r", "r")) %>%
   kable_styling(full_width = F, position = "center") %>%
   add_indent(6:16) %>%
   footnote(number = c("Mentalizing (quad) = quadratic effect of mentalizing", "Beta = standardized beta", "HPDI = 97% Highest posterior density interval", "Pr = posterior probability of Beta > 0"))
...
kable(zero.table, booktabs= T, caption = "Zero Order", align = c("l", "r", "r", "r")) %>%
   kable_styling(full_width = F, position = "center") %>%
   footnote(number = c("Beta = standardized beta", "HPDI = 97% Highest posterior density interval", "Pr = posterior probability of Beta > 0"))
