...
The main document includes a full model with all key predictors and covariates predicting disbelief. Here, we report the model sans covariates for completeness with the preregistration. Again, not much changes. In this case, mindblind atheism appears even less important.
...
full.ncs <- select(full_nc_post, b_ment, b_mentQuad, b_sec, b_cred, b_ref)
