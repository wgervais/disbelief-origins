...
posttab <- fulltab %>%
  ...
  column_spec(1, bold = T) %>%
  footnote(general = "Standardized betas for each variable predicting disbelief. ",
           number = c("HPDI = 97% highest posterior density interval; ", "Pr = probability of beta being greater than zero"),
           )
